"""``combinator-render`` — per-agent renderer process.
...
.. code-block:: bash
    ...
    combinator-render --log <path> --label <label>
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="combinator-render")
    ...
    console.print(
        f"[dim]combinator-render › [/][bold magenta]{args.label}[/] "
        f"[dim]› log {args.log}[/]"
    )
