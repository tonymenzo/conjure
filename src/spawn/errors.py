"""Error hierarchy for spawn runtime and tools.
...
class SpawnError(Exception):
    """Base class for all spawn runtime errors."""


class NotPermitted(SpawnError):
...
class MaxDepthExceeded(SpawnError):
