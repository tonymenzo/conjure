"""Declarative configuration for ``spawn run``.
...
.. code-block:: yaml
    ...
    root:
      role_prompt: |
        You are the root agent of this spawn session.
      engine: orchestral
      llm: default
...
class RootConfig(BaseModel):
    model_config = ConfigDict(extra="forbid")
    role_prompt: str
    # See ``spawn.engines.resolve_engine_name`` for ``"auto"``
