"""``conjure-render`` — per-agent renderer process.
...
.. code-block:: bash
    ...
    conjure-render --log <path> --label <label>
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="conjure-render")
    ...
    console.print(
        f"[dim]conjure-render › [/][bold magenta]{args.label}[/] "
        f"[dim]› log {args.log}[/]"
    )
